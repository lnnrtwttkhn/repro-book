...
:bulb: You know why different software versions can be a threat to reproducibility.<br>
:bulb: You can create a lockfile using the `{renv}` functions. <br>
:bulb: You can reproduce a previous environment from a lockfile.<br>
:::
