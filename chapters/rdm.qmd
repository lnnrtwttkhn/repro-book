...
However, the most important aspect might be that it is incredibly easy to **entry data** in a spreadsheet.
...
>RDM covers how research data can be stored, described and reused [@community2022, chapter on Research Data Management].
