...
There is also a [guide](https://psychds-docs.readthedocs.io/en/latest/) to help researchers organize their research projects.
Like BIDS, Psych-DS provides a validation tool that checks if the data organization has been done correctly.
