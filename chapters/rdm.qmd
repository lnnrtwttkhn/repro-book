...
What matters most, is that Reinhart and Rogoff were able to **share** their orginal spreadsheet and that the results were then **reproducible**.
...
Instead of writing `0 (below threshold)`, open up a new column calles `note` and write `0`in the first column and `below threshold` in the second.
