...
:bulb: You know how and why good coding practices help with making your work more reproducible.<br>
:bulb: You learn about how to practice good coding style. <br>
:bulb: You learn how to keep your data tidy.<br>
:bulb: You know about the `assertr` package and the function `verify()` to help you avoid issues with your data.<br>
:::
...
|:---|:---|:---|:---|:---|
|@rennie2024|Writing Better R Code|[{{< fa display >}}](https://nrennie.rbind.io/training-better-r-code/)| [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/)||
|@wickham2023|R for Data science: Import, Tidy, Transform, Visualize, and Model Data|[{{< fa display >}}](https://r4ds.hadley.nz)|[CC BY-NC-ND 3.0 US](https://creativecommons.org/licenses/by-nc-nd/3.0/us/deed.en)|[{{< fa brands github >}}](https://github.com/hadley/r4ds)|
