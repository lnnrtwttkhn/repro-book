...
To do so, you can either run the code `source("FILE PATH e.g., code/functions.R")`, placed at the top of your document or, the much smoother and efficient approach, have a **.Rprofile** file.
...
Thus if you put the `source("FILE PATH e.g., code/functions.R")` code in there, it will run that code automatically in each new session and you have your functions always available.

To set this up, follow these steps:  
1. Add new file `functions.R` to your project  
2. Add your functions directly to this file  
3A. Add the code `source("FILE PATH e.g., code/functions.R")` to the top of your document  
3B. (better) Add the file .Rprofile to your root directory and add `source("FILE PATH e.g., code/functions.R")` to it, to automatically run the sourcing process.   
