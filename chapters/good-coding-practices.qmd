...
In fact, most of the time you are facing datasets, you will spend more time organizing your data than running your analysis.
...
However, if you are interested in learning functions for data manipulation, we recommend studying the `dplyr()`-package and its [documentation](https://dplyr.tidyverse.org).
...
> Add text and code here how to change long into wide format and vice versa.
