...
When setting up your function, these are decisive which **arguments** you will later need to define when calling your function.  
...
When beginning a new R session, you need to get these functions back in your evironment.
