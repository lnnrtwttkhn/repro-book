...
```{zsh filename="Output"}
├── fpsyg-14-1090094.pdf                <- Paper in its published version
├── Materials - DataBase.xlsx           <- Dataset 
├── Materials - Informed Consent.pdf    <- Informed consent
├── Materials - Instruments.pdf         <- Survey Questions
```
