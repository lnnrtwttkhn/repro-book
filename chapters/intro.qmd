...
Open Science policies arised not only but also because of the so-called *replication crisis*.
...
As a result, many initiatives and institutions arised to enhance the credibility of research (e.g. [Center for OpenScience](https://www.cos.io), [ORION](https://www.orion-openscience.eu), and many more).
