...
#| eval: true
#| echo: false
cat(make_figure("git-initialize"))
```
...
If you just add `misc` to the `.gitignore` file, what happens, is that git stops tracking changes for all **new** files and folders in that folder.
...
#| eval: true
#| echo: false
cat(make_figure("git-initial-staging"))
```
...
#| eval: true
#| echo: false
cat(make_figure("git-wickham-monster-climb"))
```
...
cat(make_figure("git-initial-commit"))
```
...
#| eval: true
#| echo: false
#| label: git-history-love-message
cat(make_figure("git-history-love"))
```
...
#| eval: true
#| echo: false
cat(make_figure("git-revert-history"))
```
...
#| eval: true
#| echo: false
cat(make_figure("git-turing-branching"))
```
...
#| eval: true
#| echo: false
cat(make_figure("git-new-branch"))
```
...
#| eval: true
#| echo: false
cat(make_figure("git-view-branches"))
```
...
|:---|:---|:---|:---|:---|
|@community2022|Version control|[{{< fa display >}}](https://book.the-turing-way.org/reproducible-research/vcs)| [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/)|[{{< fa brands github >}}](https://github.com/the-turing-way/the-turing-way)|
|@wittkuhn2025|Version Control Book|[{{< fa display >}}](https://lennartwittkuhn.com/version-control-book/)|[CC-BY-SA-4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.en)|[{{< fa brands github >}}](https://github.com/lnnrtwttkhn/version-control-book)|
