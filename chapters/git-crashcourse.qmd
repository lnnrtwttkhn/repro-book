...
Just imagine you are working on a code, that is working pefectly fine,let's call this 01_code.
...
It might help you to imagine of these tow scenarios, when trying to create better commit messages:  
...
(Similarily, you could also think about yourself in 5 months time, not having touched your project at all and barely remembering what it was about.)  
...
Take care to use the HTTPS URL (httsp://) if you use PAT for authentification and the SSH URL (git@github.com) if you use an SSH key.
:::
