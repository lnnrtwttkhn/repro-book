...
Furthermore, it can be a great tool to collaborate with others if you make projects accessible by using remote repositories.
...
Git should come pre installed on MacOS.
To make sure, head to your command-line/Terminal and enter the following command.

```{bash}
git --version
```

This should return the version of Git that is already installed.
...
![This screenshot shows how a .gitignore file looks like in RStudio . Used under a [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0) license.](../static/git-gitignore.jpg)
...
![This screenshot shows the commit history of a repository in RStudio. Used under a [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0) license.](../static/git-history-love-message.jpg)
...
This chapter was heavily informed by [The Version Control Book](https://lennartwittkuhn.com/version-control-book/).
