...
Nevertheless, we might need to work with the command line for specific commands that do not have a specific button in RStudio.
...
::: {.callout-tip title="Why are staging and committing seperate actions?" collapse=false}
