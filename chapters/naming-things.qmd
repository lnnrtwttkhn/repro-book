...
Good names help others (and even yourself!) know what your work is about and how to use it.
...
These complexities make effective cache invalidation one of the more difficult problems in software development.
:::
...
::: {.callout-note title="Find out more: What is a slug in a URL?" collapse="true"}
...
Decide in your team a language and uniform spelling to name files and folders! Be also aware of capitalization and find a consistent style!
...
::: callout-important
Consider the use of chronologically ordered files and folders! For specifying different versions of the same document, version control tools as Git and GitHub should be preferred. Otherwise you might feel as the person in the cartoon below writing on his "final document". For different but similar files, a chronological order can make sense.
:::
