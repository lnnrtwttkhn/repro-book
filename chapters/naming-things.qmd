...
#| eval: true
#| echo: false
cat(make_figure("globbing-example-mac-psychology"))
```
:::
...
#| eval: true
#| echo: false
cat(make_figure("globbing-example-mac-biology"))
```
:::
...
|:---|:---|:---|:---|:---|
|@berd2023| Make Your Research Reproducible|||[{{< fa display >}}](https://berd-nfdi.github.io/BERD-reproducible-research-course/2-1-naming.html)|
|@bryan2015|How to name files||[CCO](https://creativecommons.org/public-domain/cc0/)|[slides](https://speakerdeck.com/jennybc/how-to-name-files)|
|@navarro|Project Structure|||[{{< fa display >}}](https://djnavarro.net/slides-project-structure/#1)|
