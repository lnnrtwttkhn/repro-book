...
Including metadata in a filename (for exampple, `2023_Experiment1_DrSmith.csv`) is helpful because it makes important details visible at a glance.
...
#### How to recover meta data from file names
...
::: {.callout-important title="When keeping copies of the same or similiar files, consider version control!"}
